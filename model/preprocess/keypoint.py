...
def run_keypoint_extraction(json_dir, target_path):
    ...
    for path in [X_KP_PKL_PATH, Y_KP_PKL_PATH,Y_KP_PKL_WO_PATH,X_KP_CSV_PATH ,Y_KP_CSV_PATH,Y_KP_CSV_WO_PATH]:
    ...
    tp = open(os.path.join(TXT_PATH + 'X_raw.pkl'), 'wb')
    yp = open(os.path.join(TXT_PATH + 'Y_raw.pkl'), 'wb')
    yp_wo = open(os.path.join(TXT_PATH + 'Y_raw_wo.pkl'), 'wb')

    tc = open(os.path.join(TXT_PATH + 'X_raw.csv'), 'w', newline='')
    yc = open(os.path.join(TXT_PATH + 'Y_raw.csv'), 'w', newline='')
    yc_wo = open(os.path.join(TXT_PATH + 'Y_raw_wo.csv'), 'w', newline='')
